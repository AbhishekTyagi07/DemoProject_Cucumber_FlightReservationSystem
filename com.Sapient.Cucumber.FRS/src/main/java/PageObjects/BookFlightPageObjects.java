...
public class BookFlightPageObjects {
	...
	public void bookFlight(){
		...
		System.out.println("Depart flight Price (Book Flight): "+depPrice);
		String strArrPrice = getFlightDetails(arrPrice);
		System.out.println("Return flight Price (Book Flight): "+arrPrice);
